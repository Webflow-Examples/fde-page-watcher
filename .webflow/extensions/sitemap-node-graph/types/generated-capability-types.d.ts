...
export interface ContentBlockTypeSummary {
    sourceId: string;
    id: string;
    title: string;
    description?: string;
...
export interface ContentBlockTypeSummaryReader {
    sourceId: string;
    id: string;
    title: string;
    description?: string;
...
export interface ContentBlockType {
    ...
    fields: {
        ...
        value: {
            kind: "text";
            presentation: "single-line" | "multiline";
        } | {
            kind: "number";
        } | {
            kind: "boolean";
...
export interface ContentBlockTypeReader {
    sourceId: string;
    id: string;
    title: string;
    description?: string;
...
export type ContentSchemaFieldValue = {
    kind: "text";
    presentation: "single-line" | "multiline";
} | {
    kind: "number";
...
export type ContentSchemaFieldValueReader = {
    kind: "text";
    presentation: string;
    [key: string]: unknown;
} | {
...
export interface ContentSchemaFieldProposal {
    machineKey: string;
    title: string;
    description?: string;
    required: boolean;
    value: ContentSchemaFieldValue;
}
export interface ContentSchemaFieldProposalReader {
    machineKey: string;
    title: string;
    description?: string;
    required: boolean;
    value: ContentSchemaFieldValueReader;
    [key: string]: unknown;
}
export interface ContentSchemaCapabilities {
    ...
    fields: {
        ...
        kinds: ("text" | "number" | "boolean" | "blocks")[];
    };
    blocksField: {
        supported: boolean;
        required: boolean;
...
export interface ContentSchemaCapabilitiesReader {
    schemaManagement: boolean;
    contentTypes: {
        create: boolean;
        deprecate: boolean;
...
export type ContentSchemaProposalOperation = {
    op: "create-content-type";
    machineKey: string;
    title: string;
    description?: string;
    itemDisplayFieldMachineKey?: string;
    fields: ContentSchemaFieldProposal[];
} | {
    op: "create-content-block-type";
    machineKey: string;
    title: string;
    description?: string;
    fields: {
    ...
    op: "add-field";
    resourceKind: "content-type" | "content-block-type";
    typeId: string;
    field: ContentSchemaFieldProposal;
} | {
    op: "change-type-metadata";
    resourceKind: "content-type";
    typeId: string;
    title?: string;
    description?: string;
    itemDisplayFieldId?: string | null;
} | {
    op: "change-type-metadata";
    resourceKind: "content-block-type";
    typeId: string;
    title?: string;
    description?: string;
} | {
    op: "change-field-metadata";
    resourceKind: "content-type" | "content-block-type";
    typeId: string;
    fieldId: string;
    title?: string;
    description?: string;
    required?: boolean;
    textPresentation?: "single-line" | "multiline";
} | {
    op: "deprecate-content-type";
    typeId: string;
} | {
    op: "deprecate-content-block-type";
    blockTypeId: string;
} | {
    op: "deprecate-field";
    resourceKind: "content-type" | "content-block-type";
...
export type ContentSchemaProposalOperationReader = {
    op: "create-content-type";
    machineKey: string;
    title: string;
    description?: string;
    itemDisplayFieldMachineKey?: string;
    fields: ContentSchemaFieldProposalReader[];
    [key: string]: unknown;
} | {
    op: "create-content-block-type";
    machineKey: string;
    ...
    resourceKind: string;
    typeId: string;
    field: ContentSchemaFieldProposalReader;
    [key: string]: unknown;
} | {
    op: "change-type-metadata";
    resourceKind: string;
...
export interface ContentSchemaChangePlan {
    planId: string;
    sourceId: string;
    status: "reviewable" | "blocked";
    summary: string;
    affectedResources?: {
        kind: "content-type" | "content-block-type" | "field";
        id: string;
        typeId?: string;
    }[];
}
export interface ContentSchemaChangePlanReader {
    planId: string;
    sourceId: string;
    status: string;
    summary: string;
...
export type ContentSchemaMutationFailure = {
    outcome: "validation_failed";
    action: "correct";
    correlationId: string;
    message?: string;
...
export type ContentSchemaMutationFailureReader = {
    outcome: "validation_failed";
    action: "correct";
    correlationId: string;
    message?: string;
...
export interface CloudGetDeployContextResultData {
    ...
    localRuntime?: "idle" | "starting" | "running";
    deployStage?: string;
...
export interface ContentRequestConnectionParams {
    sourceId: string;
}
export interface ContentRequestConnectionResultData {
    sourceId: string;
}
export interface ContentRequestConnectionResultDataReader {
    sourceId: string;
    [key: string]: unknown;
}
...
export interface ContentListBlockTypesParams {
    sourceId: string;
}
export interface ContentListBlockTypesResultData {
    sourceId: string;
    blockTypes: ContentBlockTypeSummary[];
}
export interface ContentListBlockTypesResultDataReader {
    sourceId: string;
    blockTypes: ContentBlockTypeSummaryReader[];
    [key: string]: unknown;
}
export interface ContentGetBlockTypeParams {
    sourceId: string;
    blockTypeId: string;
}
export interface ContentGetBlockTypeResultData {
    blockType: ContentBlockType | null;
}
export interface ContentGetBlockTypeResultDataReader {
    blockType: ContentBlockTypeReader | null;
    [key: string]: unknown;
}
export interface ContentGetSchemaCapabilitiesParams {
    sourceId: string;
}
export interface ContentGetSchemaCapabilitiesResultData {
    sourceId: string;
    capabilities: ContentSchemaCapabilities;
}
export interface ContentGetSchemaCapabilitiesResultDataReader {
    sourceId: string;
    capabilities: ContentSchemaCapabilitiesReader;
    [key: string]: unknown;
}
export interface ContentProposeSchemaChangeParams {
    sourceId: string;
    operations: ContentSchemaProposalOperation[];
}
export type ContentProposeSchemaChangeResultData = {
    outcome: "planned";
    plan: ContentSchemaChangePlan;
} | {
    outcome: "blocked";
    action: "correct" | "refresh";
    plan: ContentSchemaChangePlan;
    message?: string;
} | {
    outcome: "no_change";
} | ContentSchemaMutationFailure;
export type ContentProposeSchemaChangeResultDataReader = {
    outcome: "planned";
    plan: ContentSchemaChangePlanReader;
    [key: string]: unknown;
} | {
    outcome: "blocked";
    action: string;
    ...
    outcome: "no_change";
    [key: string]: unknown;
} | ContentSchemaMutationFailureReader;
export interface ContentApplySchemaChangeParams {
    sourceId: string;
    planId: string;
}
export type ContentApplySchemaChangeResultData = {
    outcome: "applied";
    planId: string;
} | ContentSchemaMutationFailure;
export type ContentApplySchemaChangeResultDataReader = {
    outcome: "applied";
    planId: string;
    [key: string]: unknown;
} | ContentSchemaMutationFailureReader;
...
export interface PreviewOpenRouteParams {
    scope?: CapabilityScopeString;
    route: string;
    input?: JsonObject;
}
export interface PreviewOpenRouteResultDataReader {
    previewId: string;
    status: string;
    url?: string;
    [key: string]: unknown;
...
export interface PublicCapabilityContractMap {
    ...
    "content.requestConnection": PublicCapabilityContract<ContentRequestConnectionParams, CapabilityOutcome<ContentRequestConnectionResultDataReader>>;
    ...
    "content.listBlockTypes": PublicCapabilityContract<ContentListBlockTypesParams, CapabilityOutcome<ContentListBlockTypesResultDataReader>>;
    "content.getBlockType": PublicCapabilityContract<ContentGetBlockTypeParams, CapabilityOutcome<ContentGetBlockTypeResultDataReader>>;
    "content.getSchemaCapabilities": PublicCapabilityContract<ContentGetSchemaCapabilitiesParams, CapabilityOutcome<ContentGetSchemaCapabilitiesResultDataReader>>;
    "content.proposeSchemaChange": PublicCapabilityContract<ContentProposeSchemaChangeParams, CapabilityOutcome<ContentProposeSchemaChangeResultDataReader>>;
    "content.applySchemaChange": PublicCapabilityContract<ContentApplySchemaChangeParams, CapabilityOutcome<ContentApplySchemaChangeResultDataReader>>;
    ...
    "preview.openRoute": PublicCapabilityContract<PreviewOpenRouteParams, CapabilityOutcome<PreviewOpenRouteResultDataReader>>;
