...
interface PublicCapabilityReaderContractMap {
    ...
    readonly "content.requestConnection": RequestReaderContract<"request-response", "required", "required", "optional", "content", "requestConnection">;
    ...
    readonly "content.listBlockTypes": RequestReaderContract<"request-response", "required", "required", "optional", "content", "listBlockTypes">;
    readonly "content.getBlockType": RequestReaderContract<"request-response", "required", "required", "optional", "content", "getBlockType">;
    readonly "content.getSchemaCapabilities": RequestReaderContract<"request-response", "required", "required", "optional", "content", "getSchemaCapabilities">;
    readonly "content.proposeSchemaChange": RequestReaderContract<"request-response", "required", "required", "optional", "content", "proposeSchemaChange">;
    readonly "content.applySchemaChange": RequestReaderContract<"request-response", "required", "required", "optional", "content", "applySchemaChange">;
    ...
    readonly "preview.openRoute": RequestReaderContract<"request-response", "required", "required", "optional", "preview", "openRoute">;
