/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=auth-gateway/wrangler.jsonc auth-gateway/worker-configuration.d.ts` (hash: 48fac0c67052a285a2c509d826e83ffc)
