/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=auth-gateway/wrangler.jsonc auth-gateway/worker-configuration.d.ts` (hash: c0b15e8bd872757c874cf1d28178981c)
