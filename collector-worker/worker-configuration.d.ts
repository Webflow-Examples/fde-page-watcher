/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=collector-worker/wrangler.jsonc collector-worker/worker-configuration.d.ts` (hash: 654ef93dfb58ecde09461c4a0a3cec15)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAGE_WATCHER_NIGHTLY_URL" | "PAGESPEED_API_KEY" | "CRON_SECRET" | "CF_ACCESS_CLIENT_ID" | "CF_ACCESS_CLIENT_SECRET">> {}
}
