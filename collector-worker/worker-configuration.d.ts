/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=collector-worker/wrangler.jsonc collector-worker/worker-configuration.d.ts` (hash: 5332bf13c6d5f2a46a4a3dfaf1dba913)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NIGHTLY_TENANT" | "PAGESPEED_API_KEY" | "CRUX_API_KEY" | "CRON_SECRET">> {}
}
