/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=collector-worker/wrangler.jsonc collector-worker/worker-configuration.d.ts` (hash: dd31a09e80a0aa64e4726d369140d90c)
// Runtime types generated with workerd@1.20260714.1 2026-07-24 nodejs_compat
interface __BaseEnv_Env {
	...
	COLLECTION_WORKFLOW: Workflow<Parameters<import("./index").CollectorWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NIGHTLY_TENANT" | "ORA_SCAN_ENABLED" | "PAGESPEED_API_KEY" | "CRUX_API_KEY" | "CRON_SECRET" | "WEBFLOW_TOKEN_ENCRYPTION_KEY">> {}
}
