/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=collector-worker/wrangler.jsonc collector-worker/worker-configuration.d.ts` (hash: b04549d8799870966f4f603cd52ab53f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAGESPEED_API_KEY" | "CRON_SECRET">> {}
}
