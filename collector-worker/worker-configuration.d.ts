/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=collector-worker/wrangler.jsonc collector-worker/worker-configuration.d.ts` (hash: cfb35aaa32e1b87d2db03cf20628d5fb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NIGHTLY_TENANT" | "PAGESPEED_API_KEY" | "CRUX_API_KEY" | "CRON_SECRET" | "WEBFLOW_TOKEN_ENCRYPTION_KEY">> {}
}
